...
public class UserSecond extends JFrame implements ActionListener, Runnable{
    ...
    UserSecond(){
       ...
       ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("friends.jpg"));
       ...
       JLabel l4 = new JLabel("Rachel, Ross, Chandler, Monica");
       ...
       try{
           ...
           Socket socketClient = new Socket("localhost", 2008);
